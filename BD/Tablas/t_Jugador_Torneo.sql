...
(
   ...
   ,jgtr_estado       BOOLEAN       CONSTRAINT nn_jgtr_estado       NOT NULL DEFAULT TRUE
...
COMMENT ON COLUMN t_Jugador_Torneo.jgtr_equipo       IS 'Equipo donde esta asociado el jugador';
COMMENT ON COLUMN t_Jugador_Torneo.jgtr_nro_camiseta IS 'Numero de camiseta con el que juega';
COMMENT ON COLUMN t_Jugador_Torneo.jgtr_estado       IS 'Estado del jugador en el torneo, TRUE indica activo, FALSE indica inactivo';
