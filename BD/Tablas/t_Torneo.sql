...
(
   ...
   ,trno_jugadores_cancha NUMERIC(2,0)  CONSTRAINT nn_trno_jugadores_cancha NOT NULL
   ,trno_genero           VARCHAR(1)
   ,trno_fecini           TIMESTAMP     CONSTRAINT nn_trno_fecini           NOT NULL
   ,trno_fecfin           TIMESTAMP     CONSTRAINT nn_trno_fecfin           NOT NULL
   ,trno_estado           VARCHAR(1)    CONSTRAINT nn_trno_estado           NOT NULL DEFAULT 'P'
   ,trno_dprt             NUMERIC(3,0)  CONSTRAINT nn_trno_dprt             NOT NULL
...
COMMENT ON COLUMN t_Torneo.trno_jugadores_cancha IS 'Numero de jugadores en cancha';
...
COMMENT ON COLUMN t_Torneo.trno_estado           IS 'Estado del torneo, P - Programado, E - En ejecucion, F - Finalizado';
